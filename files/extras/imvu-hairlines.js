...
Dygraph.Plugins.ImvuHairlines = (function() {
...
hairlines.prototype.createHairline = function(props) {
  ...
  var $wrapperDiv = $('<div/>').addClass('dygraph-hairline-wrapper');
  ...
  $lineContainerDiv.appendTo($wrapperDiv);
  $infoDiv.appendTo($wrapperDiv);
